...
data class AppStrings(
    ...
    data class Projects(
        ...
        val instructionsBlurb: String,
        val instructionsPlaceholder: String,
        val knowledge: String,
        val knowledgeBlurb: String,
        val addFiles: String,
        val uploading: String,
        val noFiles: String,
        val chats: String,
        val noChats: String,
        val newChatHere: String,
        val pin: String,
        val unpin: String,
        val archive: String,
    ...
    data class SettingsInterface(
        ...
        val streamPatience: String,
        val streamPatienceHint: String,
