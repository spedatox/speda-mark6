...
CONFIG_GROUPS: list[ConfigGroup] = [
    ...
    ConfigGroup(
        ...
        [
            ...
            ConfigField("system_ops_enabled", "Orion Host Ops", "bool",
                        help="Privileged host operations for Orion. Off by default."),
            ConfigField("system_ops_root", "Host Ops Write Jail", "text",
                        help="Confines any file write Orion makes to this subtree."),
