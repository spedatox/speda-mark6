...
export default function MemoryExplorerModal({
  ...
  const { currentFolders, currentFiles } = useMemo(() => {
    ...
    let folders = rawFolders.map(name => {
      ...
      // Count files inside this folder recursively
  ...
  const handleConfirmRename = async () => {
    ...
    try {
      if (renameDialog.item.type === 'file') {
        ...
        // Renaming a folder means renaming all files under this folder
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Navigation Bar (Back, Forward, Up, Breadcrumbs, Search) */}
        <div
          style={{
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            {/* Rename button (active if an item is selected) */}
            <button
            ...
            {/* Delete button (active if an item is selected) */}
            <button
          ...
          {/* Right Actions: View mode & Refresh */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <button
              onClick={loadFiles}
              title="Yenile"
