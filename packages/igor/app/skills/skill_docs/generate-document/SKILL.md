...
Every generated file is signed automatically with your name and your own mark —
`Generated by Sentinel Mark II` — on the PPTX cover slide and as the closing line
of a DOCX or PDF. You do not write it. Putting a "Generated by" line in `content`
signs the file twice.

## Do not

- Write your own signature or "Generated by" footer into `content`
