# SPEDA Mark VI — build the desktop installer, pointed at your server.
#
...
Write-Host ""
Write-Host "  Building SPEDA Mark VI -> $ApiBase" -ForegroundColor Cyan
Write-Host ""

# electron-vite exposes MAIN_VITE_* to the main process at build time.
