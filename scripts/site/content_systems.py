...
<section>
  <div class="wrap">
    ...
    <div class="prose" style="margin-top:clamp(2.6rem,5vw,4rem)">
      ...
      <p>Both peers are separate Forge processes that connect independently on their agent-specific sockets.
        Igor keeps the proxy-when-online, fallback-when-offline routing decision, but does not own the peer
        processes' lifecycle.</p>
    </div>
